    ...
    if (err) {
      ...
      .then((answer) => {
        ...
        if (answer.confirm !=="DELETE") {
            ...
            db.query(`DELETE FROM employee WHERE id = ${selectedEmployee}`, 
            (err, answer) => {
                if (err) {
                  throw err;
                } else {
        ...
        if (err) {
          ...
          .then((answer) => {
            ...
            if (answer.confirm !=="DELETE") {
                ...
                db.query(`DELETE FROM role WHERE id = ${selectedRole}`, 
                (err, answer) => {
                    if (err) {
                      throw err;
                    } else {
        ...
        if (err) {
          ...
          .prompt([
            {
              ...
              message: "Select the department you want to DELETE from the database",
          ...
          .then((answer) => {
            ...
            if (answer.confirm !=="DELETE") {
                ...
                db.query(`DELETE FROM department WHERE id = ${selectedDepartment}`, 
                (err, answer) => {
                    if (err) {
                      throw err;
                    } else {
